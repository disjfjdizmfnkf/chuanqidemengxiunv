...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() != this.getClass()){return false;} //验证o的类型是否是SimpleOomage
        SimpleOomage that = (SimpleOomage)o; //保证强制类型转换有作用之后进行转换避免出错
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            return (red / 5 * 54 + green / 5) * 54 + blue / 5;      //注意r g b都是5的倍数
        }
    }
